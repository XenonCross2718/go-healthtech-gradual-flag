...
The single thin client is the seam: add a method that calls another `/v1/...` route (e.g. one of flags.set, flags.rollout, flags.get_value) and reuse it from your own code.
